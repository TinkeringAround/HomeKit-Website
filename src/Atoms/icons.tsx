...
export const AC: FC<Props> = ({ active, mini = false, width = '80%', height = '80%' }) => {
  const colorMini = active ? theme.global.colors.headingActive : theme.global.colors.headingInactive
  const color = active ? theme.global.colors.iconActive : theme.global.colors.iconInactive

  return (
    <svg viewBox="0 0 39 32" height={height} width={width}>
      <title>ac</title>
      <path
        fill={mini ? colorMini : color}
...
export const Humidity: FC<Props> = ({ active, mini = false, width = '80%', height = '80%' }) => {
  const colorMini = active ? theme.global.colors.headingActive : theme.global.colors.headingInactive
  const color = active ? theme.global.colors.iconActive : theme.global.colors.iconInactive
  ...
  return (
    <svg id="icon-humidity" viewBox="0 0 39 32" width={width} height={height}>
      ...
      <path
        fill="transparent"
        stroke={mini ? colorMini : color}
        d="M10.508 20.36c0 0 0.933 6.18 7.233 7.653"
      />
    </svg>
  )
}

export const Light: FC<Props> = ({ active, mini = false, width = '80%', height = '80%' }) => {
  const colorMini = active ? theme.global.colors.headingActive : theme.global.colors.headingInactive
  const color = active ? theme.global.colors.iconActive : theme.global.colors.iconInactive
  ...
  return (
    <svg id="icon-light" viewBox="0 0 39 32" width={width} height={height}>
      ...
      />
      <path fill={mini ? colorMini : color} d="M15.615 24.455h7.636v1.091h-7.636v-1.091z" />
      <path fill={mini ? colorMini : color} d="M15.615 27.182h7.636v1.091h-7.636v-1.091z" />
      <path fill={mini ? colorMini : color} d="M17.251 29.909h4.364v1.091h-4.364v-1.091z" />
    </svg>
  )
}

export const Sensor: FC<Props> = ({ active, mini = false, width = '65%', height = '65%' }) => {
  const colorMini = active ? theme.global.colors.headingActive : theme.global.colors.headingInactive
  const color = active ? theme.global.colors.iconActive : theme.global.colors.iconInactive
...
export const Temperature: FC<Props> = ({ active, mini = false, width = '80%', height = '80%' }) => {
  const colorMini = active ? theme.global.colors.headingActive : theme.global.colors.headingInactive
  const color = active ? theme.global.colors.iconActive : theme.global.colors.iconInactive
  ...
  return (
    <svg id="icon-temp" viewBox="0 0 39 32" width={width} height={height}>
      ...
      />
      <path fill={mini ? colorMini : color} d="M9.755 2.963h10.076v1.185h-10.076v-1.185z" />
      <path fill={mini ? colorMini : color} d="M12.718 5.927h7.112v1.185h-7.112v-1.185z" />
      <path fill={mini ? colorMini : color} d="M12.718 8.891h7.112v1.185h-7.112v-1.185z" />
      <path fill={mini ? colorMini : color} d="M9.755 11.854h10.076v1.185h-10.076v-1.185z" />
      <path fill={mini ? colorMini : color} d="M12.718 14.818h7.112v1.185h-7.112v-1.185z" />
      <path fill={mini ? colorMini : color} d="M12.718 17.781h7.112v1.185h-7.112v-1.185z" />
      <path fill={mini ? colorMini : color} d="M9.755 20.745h10.076v1.185h-10.076v-1.185z" />
    </svg>
  )
}

export const Window: FC<Props> = ({ active, mini = false, width = '80%', height = '80%' }) => {
  const colorMini = active ? theme.global.colors.headingActive : theme.global.colors.headingInactive
  const color = active ? theme.global.colors.iconActive : theme.global.colors.iconInactive
  ...
  return (
    <svg id="icon-window" viewBox="0 0 39 32" width={width} height={height}>
      ...
      <path
        fill={mini ? colorMini : color}
        d="M31.422 13.333v17.333h-24v-17.333h24zM32.755 12h-26.667v20h26.667v-20z"
      />
      <path fill={mini ? colorMini : color} d="M18.755 12.667h1.333v18.667h-1.333v-18.667z" />
      <path fill={mini ? colorMini : color} d="M31.422 21.333v1.333h-25.333v-1.333h25.333z" />
    </svg>
  )
}
