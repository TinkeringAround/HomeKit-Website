...
export const AC: FC<Props> = ({ active, width = '80%', height = '80%' }) => (
...
export const Humidity: FC<Props> = ({ active, width = '80%', height = '80%' }) => (
  <ThemeContext.Consumer>
    {theme => {
      //@ts-ignore
      const color = active ? theme.global.colors.iconActive : theme.global.colors.iconInactive
...
export const Light: FC<Props> = ({ active, width = '80%', height = '80%' }) => (
  <ThemeContext.Consumer>
    {theme => {
      //@ts-ignore
      const color = active ? theme.global.colors.iconActive : theme.global.colors.iconInactive
      ...
      return (
        <svg id="icon-light" viewBox="0 0 39 32" width={width} height={height}>
          ...
          <path
            fill={color}
            style={{ fill: color }}
            d="M15.615 24.455h7.636v1.091h-7.636v-1.091z"
          />
          <path
            fill={color}
            style={{ fill: color }}
            d="M15.615 27.182h7.636v1.091h-7.636v-1.091z"
          />
          <path
            fill={color}
            style={{ fill: color }}
            d="M17.251 29.909h4.364v1.091h-4.364v-1.091z"
          />
        </svg>
      )
    }}
...
export const Sensor: FC<Props> = ({ active, width = '65%', height = '65%' }) => (
  <ThemeContext.Consumer>
    {theme => {
      //@ts-ignore
      const color = active ? theme.global.colors.iconActive : theme.global.colors.iconInactive
...
export const Temperature: FC<Props> = ({ active, width = '80%', height = '80%' }) => (
  <ThemeContext.Consumer>
    {theme => {
      //@ts-ignore
      const color = active ? theme.global.colors.iconActive : theme.global.colors.iconInactive
      ...
      return (
        <svg id="icon-temp" viewBox="0 0 39 32" width={width} height={height}>
          ...
          />
          <path stroke={color} style={{ stroke: color }} d="M24.875 3.26v24.775" />
          <path
            fill={color}
            style={{ fill: color }}
          ...
          <path
            fill={color}
            style={{ fill: color }}
            d="M9.755 2.963h10.076v1.185h-10.076v-1.185z"
          />
          <path fill={color} style={{ fill: color }} d="M12.718 5.927h7.112v1.185h-7.112v-1.185z" />
          <path fill={color} style={{ fill: color }} d="M12.718 8.891h7.112v1.185h-7.112v-1.185z" />
          <path
            fill={color}
            style={{ fill: color }}
            d="M9.755 11.854h10.076v1.185h-10.076v-1.185z"
          />
          <path
            fill={color}
            style={{ fill: color }}
            d="M12.718 14.818h7.112v1.185h-7.112v-1.185z"
          />
          <path
            fill={color}
            style={{ fill: color }}
            d="M12.718 17.781h7.112v1.185h-7.112v-1.185z"
          />
          <path
            fill={color}
            style={{ fill: color }}
            d="M9.755 20.745h10.076v1.185h-10.076v-1.185z"
          />
        </svg>
      )
    }}
...
export const Window: FC<Props> = ({ active, width = '80%', height = '80%' }) => (
  <ThemeContext.Consumer>
    {theme => {
      //@ts-ignore
      const color = active ? theme.global.colors.iconActive : theme.global.colors.iconInactive
      ...
      return (
        <svg id="icon-window" viewBox="0 0 39 32" width={width} height={height}>
          ...
          <path
            fill={color}
            style={{ fill: color }}
            d="M18.755 12.667h1.333v18.667h-1.333v-18.667z"
          />
          <path
            fill={color}
            style={{ fill: color }}
            d="M31.422 21.333v1.333h-25.333v-1.333h25.333z"
          />
        </svg>
      )
    }}
